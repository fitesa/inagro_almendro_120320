...
var style_IndicedeVegetacion_2 = function(feature, resolution){
    ...
    if (value >= 0.201329 && value <= 0.290469) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.290469 && value <= 0.379610) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 4.0 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.379610 && value <= 0.468750) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 4.0 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.468750 && value <= 0.557891) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 4.0 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.557891 && value <= 0.647031) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 4.0 + size,
